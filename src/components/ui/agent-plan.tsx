...
import { CheckCircle2, Circle, AlertCircle as CircleAlert, CircleDotDashed, Circle as CircleX } from "lucide-react";
...
export default function Plan({ initialTasks = [], onTasksChange }: PlanProps) {
  ...
  if (tasks.length === 0) {
    return (
      <div className="bg-background text-foreground h-full overflow-auto p-6">
        <div className="bg-card border-appBorder rounded-xl border shadow-sm p-8 text-center">
  ...
  return (
    <div className="bg-background text-foreground h-full overflow-auto p-2">
      <motion.div 
        className="bg-card border-appBorder rounded-xl border shadow-sm overflow-hidden"
            ...
            <ul className="space-y-1 overflow-hidden">
              {tasks.map((task, index) => {
                ...
                return (
                  ...
                  >
                    <motion.div 
                      className="group flex items-center px-3 py-1.5 rounded-xl"
                      whileHover={{ 
                            ...
                            <div className="flex items-center mr-2">
                              <div className="flex flex-wrap gap-1">
                                {task.dependencies.map((dep, idx) => (
                                  <motion.span
                                    key={idx}
                                    className="bg-secondary/40 text-secondary-foreground rounded-lg px-1.5 py-0.5 text-[10px] font-medium"
                          ...
                          <ul className="mt-1 mr-2 mb-1.5 ml-3 space-y-0.5">
                            {task.subtasks.map((subtask) => {
                              ...
                              return (
                                ...
                                >
                                  <motion.div 
                                    className="flex flex-1 items-center rounded-xl p-1"
                                    whileHover={{ 
                                      backgroundColor: "rgba(0,0,0,0.03)",
                                      transition: { duration: 0.2 }
                                    }}
                                  ...
                                  <AnimatePresence mode="wait">
                                    {isSubtaskExpanded && (
                                      <motion.div 
                                        className="text-muted-foreground mt-1 ml-1.5 border-l-2 border-dashed border-muted-foreground/30 pl-5 text-xs overflow-hidden"
